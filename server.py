...
def generate_gift_for_sale_page(gift_id, host=""):
    ...
    new_auction_info = (
        ...
        '<dd class="tm-list-item-value"><span class="accent-color">Seeing Red'
        '<span class="tm-label-secondary"> 2%</span></span></dd></dl>'
        '<dl class="tm-list-item"><dt class="tm-list-item-title">Backdrop</dt>'
        '<dd class="tm-list-item-value"><span class="accent-color">Khaki Green'
        '<span class="tm-label-secondary"> 2%</span></span></dd></dl>'
        '<dl class="tm-list-item"><dt class="tm-list-item-title">Symbol</dt>'
        '<dd class="tm-list-item-value"><span class="accent-color">Gold'
        '<span class="tm-label-secondary"> 1%</span></span></dd></dl>'
